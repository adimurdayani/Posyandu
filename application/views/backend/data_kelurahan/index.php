...
<div class="content-page">
          ...
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
              ...
              <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                ...
                <tbody>
                  <?php $no = 1; foreach($get_kelurahan as $data):?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="" class="badge badge-warning" data-toggle="modal"
                        data-target="#edit-modal<?= $data['id']?>"><i class="mdi mdi-grease-pencil"
                          title="Edit"></i></a>
                      <br>
                      <a href="<?= base_url('backend/kelurahan/hapus/'). $data['id']?>" class="badge badge-danger"><i
      ...
      <form action="<?= base_url('backend/kelurahan')?>" class="parsley-examples" method="POST">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Add Kelurahan</h4>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="kelurahan" class="form-control" value="<?= set_value('kelurahan')?>"
                    id="kelurahan" placeholder="Enter your kelurahan" required>
                </div>
              </div>
            </div>
  ...
  <div id="edit-modal<?= $kelurahan['id']?>" class="modal fade" tabindex="-1" role="dialog"
